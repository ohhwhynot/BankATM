...
public class AdminScreen extends JFrame {
    ...
    private void initComponents() {
                ...
                .setHorizontalGroup(
                        contentPaneLayout.createParallelGroup()
                                .addGroup(GroupLayout.Alignment.TRAILING,
                                        contentPaneLayout.createSequentialGroup().addContainerGap(205, Short.MAX_VALUE)
                                                .addComponent(label1).addGap(74, 74, 74).addComponent(logout)
                                                .addGap(61, 61, 61))
                                .addGroup(contentPaneLayout
                                        .createSequentialGroup().addGap(107, 107, 107).addGroup(contentPaneLayout
                                                .createParallelGroup()
                                                .addGroup(contentPaneLayout.createSequentialGroup().addComponent(label2)
                                                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                                        .addComponent(username))
                                                .addGroup(contentPaneLayout.createSequentialGroup()
                                                        .addGroup(contentPaneLayout.createParallelGroup()
                                                                .addComponent(updateStock, GroupLayout.PREFERRED_SIZE,
                                                                        160, GroupLayout.PREFERRED_SIZE)
                                                                .addComponent(checkProfit, GroupLayout.PREFERRED_SIZE,
                                                                        160, GroupLayout.PREFERRED_SIZE))
                                                        .addGap(74, 74, 74).addComponent(checkLogs,
        ...
        contentPaneLayout.setVerticalGroup(contentPaneLayout.createParallelGroup().addGroup(contentPaneLayout
                ...
                .addGroup(contentPaneLayout
                        .createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(label1).addComponent(logout))
                .addGap(34, 34, 34)
