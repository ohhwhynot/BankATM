...
public class SignUpScreen extends JFrame {
    ...
    private void signUpPerformed(ActionEvent e) {
        ...
        if(!true){ //check if existed
            JOptionPane.showMessageDialog(null,"That username is taken","Error",
                    JOptionPane.ERROR_MESSAGE);
        }
        if(!password.equals(passwordC)){
            JOptionPane.showMessageDialog(null,"Those passwords didn’t match","Error",
                    JOptionPane.ERROR_MESSAGE);
        }else{
            //todo sign
        }
                        ...
                        .addGroup(contentPaneLayout.createSequentialGroup()
                            ...
                            .addGroup(contentPaneLayout.createParallelGroup()
                                .addGroup(contentPaneLayout.createSequentialGroup()
                                    ...
                                    .addComponent(passwordField2, GroupLayout.PREFERRED_SIZE, 139, GroupLayout.PREFERRED_SIZE))
                                .addGroup(contentPaneLayout.createSequentialGroup()
                                    .addGroup(contentPaneLayout.createParallelGroup()
                                        .addComponent(label2)
                                    ...
                                    .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                    .addGroup(contentPaneLayout.createParallelGroup()
                                        .addComponent(UsernameF, GroupLayout.PREFERRED_SIZE, 139, GroupLayout.PREFERRED_SIZE)
                                        .addComponent(passwordField1, GroupLayout.PREFERRED_SIZE, 139, GroupLayout.PREFERRED_SIZE)))))
                        .addGroup(contentPaneLayout.createSequentialGroup()
                            .addGap(69, 69, 69)
